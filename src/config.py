...
4. Если к этому моменту номер коносамента не найден, проверь найденные контейнеры. Если какой-то из них не соответствует [A-Z]{{3}}U\s?[0-9]{{7}}, то это номер коносамента.
5. Если информация не найдена, впиши "".
""".strip()
